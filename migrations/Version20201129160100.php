 ...
 */
final class Version20201129160100 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT NOT NULL, title VARCHAR(1000) NOT NULL, description TEXT DEFAULT NULL, create_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, update_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, is_published BOOLEAN NOT NULL, image VARCHAR(500) DEFAULT NULL, PRIMARY KEY(id))');
